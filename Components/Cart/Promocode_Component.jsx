...
const Promocode_Component = ( {handlePromocodeINput,mypromo,buttontext,navigation,total}) => {
    return (
        <Box w={{ base: '100%', lg: '45%' }}>
            ...
            <Box  h={"100%"} w={"70%"} pr={"3px"}>
                <Text mt={"20px"} fontWeight={"500"} color={"white"} fontSize={"13px"} mb={"5px"}>Become pharma's First Member</Text>
            ...
            <PaymentDetails_Component total={total} buttontext={buttontext} navigation={navigation}/>
            <Box mt='-20px' p='15px'>
