      ...
      >
        ...
        <Box>
          <img
            ...
            width="508px"
            height="718px"
            src="https://img.freepik.com/free-vector/pharmacy-paper-bag-medicine_603843-3825.jpg?size=626&ext=jpg&ga=GA1.1.1671914043.1682257384&semt=ais"
            alt=""
          />
        </Box>
          ...
          <Box>
            <Flex mt={-230} minH={"100vh"} align={"center"} justify={"center"}>
              <Stack spacing={8} mt={40} mx={"auto"} maxW={"lg"} py={12} px={6}>
                <Stack>
                  <Heading fontSize={"3xl"}>Register Here!!!</Heading>
                  <Text fontSize={"base"} mb={80} color={"gray.600"}>
                    Register here to access your orders, special offers,
                ...
                <Box rounded={"sm"}>
                  ...
                  <Box spacing={4}>
                    <FormControl>
                      <FormLabel mb={4} ml={0} fontSize={"sm"}>
                        Full Name
                      </FormLabel>
                      <Input
